...
export default function CardProject({
  ...
  return (
    <div className="w-[80%] rounded-2xl m-auto mt-[20px] flex flex-col md:flex-row justify-between items-center md:h-[300px] xl:w-[1000px] bg-gray-200 dark:bg-gray-900">
